import{C as e,D as t,E as n,I as r,T as i,f as a,k as ee,l as te,m as o,v as ne,w as s}from"./InterProcessCommunication.js";import{$ as c,A as re,B as ie,C as l,D as u,E as d,F as ae,G as f,H as p,I as oe,J as se,K as m,L as ce,M as h,N as le,O as ue,P as de,Q as g,R as fe,S as _,T as v,U as y,V as pe,W as b,X as x,Y as S,Z as C,_ as w,a as T,b as E,c as D,d as O,f as k,g as A,h as j,i as M,j as N,k as P,l as F,m as I,n as L,o as R,p as z,q as B,r as me,s as he,t as ge,u as _e,v as ve,w as ye,x as be,y as xe,z as Se}from"./Vendor.js";import{n as V}from"./DownloadTask.js";import{n as H,r as Ce,t as we}from"./InteractiveFileContentProvider.js";var Te=m`
    :host {
...
`,Ee=b`<slot></slot>`,FluentCard=class extends B{};FluentCard.define({name:`fluent-card`,template:Ee,styles:Te});var De=m`
    :host {
        display: contents;
    }
`,Oe=b`
...
`,Ae=b`
    <div id="widgets">
        ${p(e=>e.SettingsManager.SettingPanelBookmarks||e.SettingsManager.SettingPanelDownloads,b`
    <div id="sidepanel">
...
`,Me=b`
    ...
    ${p(e=>!e.previewEntry,Ae)}
    ${p(e=>e.previewEntry,je)}
`,J=class App extends B{SelectedWebsiteChanged(e){this.selectedWebsite=e.detail,this.selectedWebsite?.IsSameAs(this.selectedTitle?.Parent)||(this.selectedTitle=void 0)}SelectedMediaTitleChanged(e){this.selectedTitle=e.detail,this.selectedTitle&&(this.selectedWebsite||this.selectedTitle?.Parent)&&!this.selectedWebsite?.IsSameAs(this.selectedTitle?.Parent)&&(this.selectedWebsite=this.selectedTitle?.Parent)}};H([q],J.prototype,`SettingsManager`,void 0),H([C],J.prototype,`selectedWebsite`,void 0),H([C],J.prototype,`selectedTitle`,void 0),H([C],J.prototype,`previewEntry`,void 0),J=H([se({name:`fluent-app`,template:Me,styles:ke})],J);var WindowManager=class{constructor(e){this.windowController=e,this.IsMaximized=!1,this.windowController.Maximized.Subscribe(e=>this.IsMaximized=e)}Minimize(){this.windowController.Minimize()}Maximize(){this.windowController.Maximize()}Restore(){this.windowController.Restore()}Close(){this.windowController.Close()}};H([C],WindowManager.prototype,`IsMaximized`,void 0);var Y=g.createContext();function __decorateParam(e,t){return function(n,r){t(n,r,e)}}var X=class LocalizationProvider{constructor(e){this.SettingsManager=e,this.Locale=a(),this.SettingsManager.SettingLanguage.Subscribe(()=>this.Locale=a())}Get(e,...t){return this.Locale[e](...t)}};H([C],X.prototype,`Locale`,void 0),X=H([__decorateParam(0,q)],X);var Z=g.createContext(),Ne=m`
...
`,Pe=b`
    <fluent-button icon-only appearance="transparent" :title=${e=>e.Localization.Locale.Frontend_FluentCore_Button_ToggleTheme_Description(e.Localization.Get(G.label))} :innerHTML=${()=>ce} @click=${e=>e.SettingsManager.SettingSelectedTheme=G}></fluent-button>
`,Fe=b`
    <fluent-button icon-only appearance="transparent" :title=${e=>e.Localization.Locale.Frontend_FluentCore_Button_ToggleTheme_Description(e.Localization.Get(W.label))} :innerHTML=${()=>fe} @click=${e=>e.SettingsManager.SettingSelectedTheme=W}></fluent-button>
`,Ie=b`
    <fluent-menu id="menu">
        ...
        <fluent-menu-list id="menu-popup">
            ...
            <fluent-menu-item role="menuitemcheckbox" title="${e=>e.Localization.Locale.Frontend_FluentCore_Settings_ShowDownloadsPanel_Description()}" :checked=${e=>e.SettingsManager.SettingPanelDownloads} @change=${(e,t)=>e.SettingsManager.SettingPanelDownloads=t.eventTarget().checked}>
                <div slot="start" :innerHTML=${()=>oe}></div>
            ...
            <fluent-menu-item title="${e=>e.Localization.Locale.Frontend_FluentCore_Menu_OpenSettings_Description()}" @click=${e=>e.ShowGlobalSettingsDialog()}>
                <div slot="start" :innerHTML=${()=>u}></div>
            ...
            <fluent-menu-item title="${e=>e.Localization.Locale.Frontend_FluentCore_Menu_ImportBookmarks_Description()}" @click=${e=>e.ImportBookmarks()}>
                <div slot="start" :innerHTML=${()=>de}></div>    
            ...
            <fluent-menu-item title="${e=>e.Localization.Locale.Settings_FeatureFlags_Description()}">
                ...
                <fluent-menu-list slot="submenu">
                    <fluent-menu-item role="menuitemcheckbox" title="${e=>e.Localization.Locale[HakuNeko.FeatureFlags.HideSplashScreen.Description]()}" :checked=${()=>!HakuNeko.FeatureFlags.HideSplashScreen.Value} @change=${(e,t)=>HakuNeko.FeatureFlags.HideSplashScreen.Value=!t.eventTarget().checked}>
                        <div slot="start" :innerHTML=${()=>h}></div>
...
`;function CreateItemTemplate$3(e){return b`<fluent-download-manager-task :Entry=${e=>e}></fluent-download-manager-task>`}var Be=b`
    <div id="header">
...
`,Ue=b`
    ...
    <div class="controls">
        ...
        <div class="status ${e=>e.status}" :innerHTML=${e=>Ve[e.status]} @click=${e=>e.ShowErrors()}></div>
...
`;function CreateItemTemplate$2(e,t=e=>!0){let n=[`height: 42px`,`padding: var(--spacingHorizontalXS)`,`border-top: var(--strokeWidthThin) solid var(--colorNeutralStrokeSubtle)`,`gap: var(--spacingHorizontalXS)`,`display: grid`,`grid-template-rows: min-content 1fr`,`grid-template-columns: min-content 1fr`,`cursor: pointer`].join(`;`),r=[n,`opacity: 0.5`].join(`;`),i=[`margin-right: var(--spacingHorizontalXS)`,`height: inherit`,`grid-row: 1 / -1`].join(`;`),a=[`overflow: hidden`,`white-space: nowrap`,`text-overflow: ellipsis`].join(`;`);return b`
        <div  style="${e=>t(e)?n:r}" onmouseover="this.style.backgroundColor = getComputedStyle(this).getPropertyValue('--colorNeutralBackground1Hover')" onmouseout="this.style.backgroundColor = ''" @click=${t=>e(t)}>
            ...
            <div style="${[a,`font-weight: bold`].join(`;`)}">${e=>e.Title}</div>
            <div style="${[a,`color: var(--colorNeutralForeground4)`].join(`;`)}">${e=>e.Identifier}</div>
        </div>
    `}var qe=b`
...
`;function CreateItemTemplate(e){return b`
        <div class="entry" style="${Qe}" onmouseover="this.querySelector('div.controls').style.visibility = 'visible'" onmouseout="this.querySelector('div.controls').style.visibility = 'hidden'">
            <div style="${Q}"><!-- <fluent-checkbox></fluent-checkbox> --></div>
            <div style="${Q}">${e=>e.Title}</div>
            <div class="controls" style="${$e}">
                <fluent-button
                    icon-only
                    appearance="transparent"
...
`,ct=b`
    <div class="info">
        ${e=>e.Item&&e.Info?at:b`┄`}
    </div>
    ${e=>e.Image?ot:st}
`,MediaItemPage=class extends B{constructor(...e){super(...e),this.abort=noop,this.Image=void 0,this.Info=void 0}disconnectedCallback(){super.disconnectedCallback(),this.Item=void 0}ItemChanged(){this.abort(),this.Image=void 0,window.clearTimeout(this.timerLoadPage),this.timerLoadPage=window.setTimeout(()=>{this.Item&&(window.clearTimeout(this.timerLoadPage),this.LoadPage())},500)}ImageChanged(e,t){e?.startsWith(`blob:`)&&URL.revokeObjectURL(e),t?.startsWith(`blob:`)||(this.Info=void 0)}async LoadPage(){try{let e=new AbortController;this.abort=()=>{this.abort=noop,e.abort()};let t=await this.Item.Fetch(ne.High,e.signal);if(this.abort=noop,!t||e.signal.aborted)return;this.Image=URL.createObjectURL(t),this.Info=`${t.type} @ ${t.size.toLocaleString(`en-US`,{useGrouping:!0})}`}catch(e){console.warn(e)}finally{this.abort=noop}}};H([C],MediaItemPage.prototype,`Item`,void 0),H([C],MediaItemPage.prototype,`Image`,void 0),H([C],MediaItemPage.prototype,`Info`,void 0),MediaItemPage.define({name:`fluent-media-item-page`,template:ct,styles:it});var lt=m`
    :host {
        display: block;
    }
...
`;function CreateChoiceOptionTemplate(e,t){return b`
    ...
    `}function CreateChoiceTemplate(e){return b`
        <fluent-dropdown type="dropdown" id=${e=>e.ID} @change=${(e,t)=>e.Value=t.eventTarget().value}>
            <fluent-listbox>
                ${y(e=>e.Options,t=>CreateChoiceOptionTemplate(e,t))}
            </fluent-listbox>
        </fluent-dropdown>
    `}var vt=b`
...
`;function CreateSettingTemplate(r){return b`
        ...
        ${p(e=>e instanceof ee,mt)}
        ${p(e=>e instanceof t,ht)}
        ${p(e=>e instanceof n,gt)}
        ${p(t=>t instanceof e,_t)}
        ${p(e=>e instanceof s,CreateChoiceTemplate(r))}
    ...
    <fluent-dialog type="modal" ${f(`dialog`)}>
        <fluent-dialog-body>
            ...
            <div id="settings">
                ${y(e=>e.Settings,CreateSettingTemplate)}
            </div>
...
`,xt=b`
    ${y(e=>e.visibles,e=>e.Template)}
    <div ${f(`trigger`)}></div>
`,LazyScroll=class extends B{constructor(...e){super(...e),this.observer=new IntersectionObserver(([e])=>e.isIntersecting&&this.LoadNext(100)),this.visibles=[],this.LoadNext=function(e){this.visibles.length<this.Items.length&&window.requestAnimationFrame(()=>{this.visibles=this.Items?.slice(0,this.visibles.length+e)??[]})}.bind(this)}connectedCallback(){super.connectedCallback(),this.observer.observe(this.trigger)}disconnectedCallback(){super.disconnectedCallback(),this.observer.disconnect()}ItemsChanged(){this.visibles=[],this.LoadNext(100)}};H([C],LazyScroll.prototype,`Template`,void 0),H([C],LazyScroll.prototype,`visibles`,void 0),H([C],LazyScroll.prototype,`Items`,void 0),LazyScroll.define({name:`fluent-lazy-scroll`,template:xt,styles:bt});var FluentCore=class{RegisterDependencies(e){let t=g.getOrCreateDOMContainer(document.body);t.register(c.singleton(q,SettingsManager)),t.register(c.singleton(Z,X)),t.register(c.instance(Y,new WindowManager(e))),t.register(c.singleton($,we))}async Render(e,t){this.RegisterDependencies(t),e.appendChild(new J)}},St=new FluentCore;export{St as default};